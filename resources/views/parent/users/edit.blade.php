    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
                <form method="post" enctype="multipart/form-data" action="{!! route('users.update', $edit->id) !!}">
                    @csrf
                        ...
                        <div class="">
                            <div class="mb-4">
                                ...
                                <input type="text"
                                       ...
                                       id="name" placeholder="Ad Soyad" name="name" value="{{ $edit->name }}">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="email"
                                       class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                       id="email" placeholder="Email" name="email" value="{{ $edit->email }}">
